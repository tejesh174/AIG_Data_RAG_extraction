"""
Chunking & Embedding using PySpark + sentence-transformers
...
def embed_on_driver(texts):
    if EMBEDDING_BACKEND == "openai":
        ...
        all_vecs = []
        batch_size = 256  # smaller batches to stay under TPM limit
